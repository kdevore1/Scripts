# calculate_2D_shift.py
# The purpose of this script is to calculate 2D shifts from cryoSPARC metadata and write into csv files for further manipulation
...
file_names = ['P49_box_1.0_2D_shift.csv', 'P49_box_1.5_2D_shift.csv', 'P49_box_2.0_2D_shift.csv', 
              'P51_box_1.0_2D_shift.csv', 'P51_box_1.5_2D_shift.csv', 'P49_box_2.0_2D_shift.csv',
              'P52_box_1.0_2D_shift.csv', 'P49_box_1.5_2D_shift.csv', 'P49_box_2.0_2D_shift.csv']
...
for i, j in zip(path_names, file_names):
    ...
    # taking 2D shift array
    shift = particle_dataset.from_file(dataset_path).data['alignments2D/shift']
    
    # writing to csv file
    with open(j, 'w') as file:
        writer = csv.writer(file)
        writer.writerow(shift_header)
        writer.writerows(shift)
